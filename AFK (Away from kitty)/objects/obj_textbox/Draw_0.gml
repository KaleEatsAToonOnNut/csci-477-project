...
//adjust texbox location if you want
...
if setup == false
{
    ...
    {   
        ...
        //get the x position for the textbox
            ...
            if speaker_side[p] == -1{
                text_x_offset[p] = 8;
                portrait_x_offset[p] = 216; //adjust anytime
            }
        
            // no character (center the textbox) adjust anytime
            if speaker_sprite[p] == noone {
                text_x_offset[p] = 44;
            }    
        
        //setting individual characters and finding where the lines of text should be break 
    ...
    if draw_char < text_length[page]
{
    ...
    {
        text_pause_timer = texy_pause_time;
    }
}
}
else {
...
if draw_char == text_length[page] && page == page_number - 1
{
    ...
    //draw the options
    var _op_space = 15; //height of optionsbox
    var _op_bord = 4; //space between text and box
    for (var op = 0; op < option_number; op++)
    {
        //the option box
        var _o_w = string_width(option[op]) + _op_bord*2;
        draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x + 16 /*space for arrow*/, _txtb_y - _op_space*option_number + _op_space*op, _o_w/txtb_spr_w, (_op_space-1)/txtb_spr_h, 0, c_white, 1);
        ...
        //the option text
        draw_text(_txtb_x + 16 /*space for arrow*/ + _op_bord, _txtb_y - _op_space*option_number + _op_space*op + 2, option[op]);        
    }
}
...
for (var c = 0; c < draw_char; c++)
{
    ...
    {
        float_dir[c, page] += -6; //ajust base on textsize
        _float_y = dsin(float_dir[c, page]) * 1; //adjust anytime if you want more effct
    }
